...
export default hopeTheme({
  ...
  hostname: "https://sparksding.github.io/blogs",

  author: {
    name: "还不知道叫什么名字",
    url: "https://sparksding.github.io/blogs",
  },
  ...
  plugins: {
    ...
    comment: {
      ...
      provider: "Giscus",
      repo: "SparksDing/blogs-comments",
      repoId: "R_kgDOLcWhCA",
      category: "Announcements",
      categoryId: "DIC_kwDOLcWhCM4Cdwhj"
    },
