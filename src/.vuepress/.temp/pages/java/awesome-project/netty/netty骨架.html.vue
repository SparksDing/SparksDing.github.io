<template><div><figure><img src="/assets/images/java/awesome-project/netty/netty_workflow.png" alt="netty线程模型" width="700" tabindex="0" loading="lazy"><figcaption>netty线程模型</figcaption></figure>
<figure><img src="/assets/images/java/awesome-project/netty/SingleThreadEventLoop_register.png" alt="register时序" width="500" tabindex="0" loading="lazy"><figcaption>register时序</figcaption></figure>
<p>doStartThread方法会将SingleThreadEventExecutor.this.run()提交到线程池中执行，而该run方法由NioEventLoop负责实现。</p>
<h3 id="各个类的功能" tabindex="-1"><a class="header-anchor" href="#各个类的功能" aria-hidden="true">#</a> 各个类的功能</h3>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center">NioEventLoop</td>
<td style="text-align:center">事件循环---专注于处理事件(定义了处理事件的逻辑)，与如何运行、如何调度无关</td>
</tr>
<tr>
<td style="text-align:center">NioEventLoopGroup</td>
<td style="text-align:center">NioEventLoop的管理器</td>
</tr>
<tr>
<td style="text-align:center">EventLoop</td>
<td style="text-align:center">任务执行器</td>
</tr>
<tr>
<td style="text-align:center">EventLoopGroup</td>
<td style="text-align:center">EventLoop的管理器</td>
</tr>
<tr>
<td style="text-align:center">EventExecutor</td>
<td style="text-align:center">任务调度器</td>
</tr>
<tr>
<td style="text-align:center">EventExecutorGroup</td>
<td style="text-align:center">管理EventExecutor</td>
</tr>
<tr>
<td style="text-align:center">MultithreadEventExecutorGroup</td>
<td style="text-align:center">EventExecutorGroup的实现类</td>
</tr>
<tr>
<td style="text-align:center">SingleThreadEventLoop</td>
<td style="text-align:center">任务执行器的实现</td>
</tr>
<tr>
<td style="text-align:center">SingleThreadEventExecutor</td>
<td style="text-align:center">任务调度器的实现</td>
</tr>
</tbody>
</table>
<figure><img src="/assets/images/java/awesome-project/netty/netty_event_executor.png" alt="EventExecutor" width="700" tabindex="0" loading="lazy"><figcaption>EventExecutor</figcaption></figure>
<h3 id="channel" tabindex="-1"><a class="header-anchor" href="#channel" aria-hidden="true">#</a> Channel</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">Channel</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="/assets/images/java/awesome-project/netty/netty_channel.png" alt="Channel实现类以及子类" width="500" tabindex="0" loading="lazy"><figcaption>Channel实现类以及子类</figcaption></figure>
<h3 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> 参考文章</h3>
<p><a href="https://www.cnblogs.com/sfnz/p/15138279.html" target="_blank" rel="noopener noreferrer">Netty之EventLoop<ExternalLinkIcon/></a></p>
</div></template>
