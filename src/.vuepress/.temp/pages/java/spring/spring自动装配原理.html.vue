<template><div><h3 id="invokebeanfactorypostprocessors" tabindex="-1"><a class="header-anchor" href="#invokebeanfactorypostprocessors" aria-hidden="true">#</a> invokeBeanFactoryPostProcessors</h3>
...
<h3 id="configurationclasspostprocessor" tabindex="-1"><a class="header-anchor" href="#configurationclasspostprocessor" aria-hidden="true">#</a> ConfigurationClassPostProcessor</h3>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>1. processConfigBeanDefinitions
...
<p>1.2.4 处理@Import注解: processImports(configClass, sourceClass, getImports(sourceClass), filter, true); 其中会调用selectImports方法</p>
<p>AutoConfigurationImportSelector的selectImports方法从spring.factories中读取starter需要的类。</p>
<p>其中某些特殊的类可以扫描@SpringApplication主类所在目录下所有的package，将包含注解的类加入spring容器中。</p>
</div></template>
