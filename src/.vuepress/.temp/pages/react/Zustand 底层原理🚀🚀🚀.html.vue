<template><div><p>接着上篇文章：<a href="https://juejin.cn/post/7270430481693835276" target="_blank" rel="noopener noreferrer">React 状态管理库—— zustand 为啥这么简单易用 🚀<ExternalLinkIcon/></a></p>
<p>今天探究 <code v-pre>Zustand</code> 底层原理</p>
